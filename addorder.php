...
<head>
    ...
    <link rel="stylesheet" href="public/css/add_order_style.css">
</head>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <form method="get" action="#">
                        <button type="submit" class="btn btn-lg btn-primary" name="all">all items</button>
                        </form>
                    </div> 
            </div>
                    <div class="row mt-5">
                        <div class="col-4 ">
                            <form method="get" action="#">
                                <div class="input-group">
                                    <input type="search" id="searchbar" class="form-control form-control-lg" placeholder="search item" name="name">
